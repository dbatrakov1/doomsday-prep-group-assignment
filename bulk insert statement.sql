...
BULK INSERT ResourceSite
FROM 'C:\Users\bette\Desktop\School\Data\Group Work\doomsday-prep-group-assignment\CSVs\ResourceSite.csv'
WITH
(
    FIRSTROW = 2,
    FIELDTERMINATOR = ',',
...
BULK INSERT PowerSource
FROM 'C:\Users\bette\Desktop\School\Data\Group Work\doomsday-prep-group-assignment\CSVs\PowerSource.csv'
WITH
(
    FIRSTROW = 2,
    FIELDTERMINATOR = ',',
